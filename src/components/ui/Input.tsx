...
const baseInput =
  "w-full rounded-xl bg-abyss-800 border border-slate-700/60 text-slate-100 placeholder:text-slate-600 px-3.5 py-2.5 text-sm transition-colors focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/40";
    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          {prefix && (
            <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 text-sm select-none pointer-events-none">
              {prefix}
            </span>
          )}
          <input
          ...
          />
          {suffix && (
            <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 text-sm select-none pointer-events-none">
              {suffix}
            </span>
          )}
        </div>
